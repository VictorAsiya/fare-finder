...
const Login = () => {
  ...
  useEffect(() => {
    const selectedRole = sessionStorage.getItem('selectedRole') as 'regular' | 'company' | 'admin' | null;
    if (selectedRole) {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      const response = await fetch("https://gofare.onrender.com/api/users/login/", {
        method: "POST",
        headers: {
